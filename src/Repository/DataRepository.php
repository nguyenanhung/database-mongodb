...
namespace nguyenanhung\MongoDB\Repository;

use nguyenanhung\MongoDB\ProjectInterface;
use nguyenanhung\MongoDB\VersionTrait;

/**
 * Class DataRepository
 *
 * @package   nguyenanhung\MongoDB\Repository
